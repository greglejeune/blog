...
<div class="content">
    ...
    <div class="mermaid">
        graph LR
            Defense[Comment je dois jouer ma range ?] --> Strategie[Sizing & Fréquence]
            Strategie[Sizing & Fréquence] --> Propriété[Propriété de ma main]
            Propriété[Propriété de ma main] --> Equité
            Propriété[Propriété de ma main] --> Bloqueur;
    </div>
    <h3>
        Mise en pratique
    </h3>
